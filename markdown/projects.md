...
* [HONS '26 Slides](img/slides/netsci-2026-hons.pdf)

* [IC2S2 '26 Slides](img/slides/ic2s2-2026-conf.pdf)
...
* [NetSci '26 Slides](img/slides/netsci-2026-conf.pdf)
...
* [Paper](https://doi.org/10.1371/journal.pdig.0000430): Characterizing collective physical distancing in the U.S. during the first nine months of the COVID-19 pandemic (PLOS Digital Health, 2024)
...
* [Slides](img/slides/netsci-2023-conf.pdf): Starting a Fire with Twigs: Influence of Encapsulation Relations on Bottom-up Dynamics on Hypergraphs (NetSci 2023)
...
* [Slides](img/slides/netsci-2019-hons.pdf): Detecting Path Anomalies in Sequential Data on Networks ([HONS Satellite](https://uzhdag.github.io/hons_web/2019/program.html) @ [NetSci 2019](http://netsci2019.net/))
* [Slides](img/slides/netsci-2019-conf.pdf): Detecting Path Anomalies in Sequential Data on Networks ([NetSci 2019 Conference Talk](http://netsci2019.net/))
...
* [NetSci 2020 Conference Talk](https://www.dropbox.com/s/8bcx75d37l87shu/netsci_2020_larock_final.mov?dl=0) ([slides](img/slides/netsci-2020-conf.pdf)): Frequency of Significant Sequential Motifs Reveal Patterns in Pathway Data 
...
* [Networks 2021 Conference Talk](https://www.dropbox.com/s/5saq5294gog9lkj/10217_LaRock.mp4?dl=0) ([slides](img/slides/networks-2021-conf.pdf)): Analyzing Shipping Route Data Using Higher-order Network Analysis
